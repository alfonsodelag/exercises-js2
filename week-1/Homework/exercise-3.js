...
let coffeeMachine = {
  ...
  getCoffee: function (typeOfCoffee) {
    const priceOfCoffee = this.prices[typeOfCoffee];
    console.log("priceOfCoffee", priceOfCoffee)
    console.log("this.insertedAmount", this.insertedAmount);
    if (priceOfCoffee <= this.insertedAmount) {
      this.insertedAmount = 0;
      return `Please take your ${typeOfCoffee}`;
    } else {
      return `Sorry you don't have enough money for a ${typeOfCoffee}`;
    }
  },
};
